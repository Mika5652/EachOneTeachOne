...
NSString * const kDBAnswerPhotoTableViewCellIdentifier = @"kDBAnswerPhotoTableViewCellIdentifier";
...
@interface DBAnswerPhotoTableViewCell () <UITextViewDelegate>
...
@implementation DBAnswerPhotoTableViewCell
